		...
		start	: function() {
			...
			this.each(function(index, value){
				...
				if(self.find('.loading').length == 0)
				{
					...
					self.find('.loading').css('border-top-left-radius', self.css('border-top-left-radius'));
					self.find('.loading').css('border-top-right-radius', self.css('border-top-right-radius'));
					self.find('.loading').css('border-bottom-left-radius', self.css('border-bottom-left-radius'));
					self.find('.loading').css('border-bottom-right-radius', self.css('border-bottom-right-radius'));
